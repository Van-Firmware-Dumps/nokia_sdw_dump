...
cat product/app/WallpaperPicker_sdw/WallpaperPicker_sdw.apk.* 2>/dev/null >> product/app/WallpaperPicker_sdw/WallpaperPicker_sdw.apk
rm -f product/app/WallpaperPicker_sdw/WallpaperPicker_sdw.apk.* 2>/dev/null
...
cat system/system/priv-app/NokiaSupportStub/NokiaSupportStub.apk.* 2>/dev/null >> system/system/priv-app/NokiaSupportStub/NokiaSupportStub.apk
rm -f system/system/priv-app/NokiaSupportStub/NokiaSupportStub.apk.* 2>/dev/null
...
cat vendor_bootimg/02_dtbdump_	qcom,rtic-id.dtb.* 2>/dev/null >> vendor_bootimg/02_dtbdump_	qcom,rtic-id.dtb
rm -f vendor_bootimg/02_dtbdump_	qcom,rtic-id.dtb.* 2>/dev/null
